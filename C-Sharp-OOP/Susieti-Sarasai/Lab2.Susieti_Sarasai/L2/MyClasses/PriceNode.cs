...
namespace L2.MyClasses
{
    ...
    /// A single node class 
    /// </summary>
    sealed class PriceNode
    {
        public Price Data { get; set; } //data of a node
        public PriceNode Link { get; set; } //reference to the next node in the list
        /// <summary>
        ...
        public PriceNode(Price value, PriceNode address)
        {
            Data = value;
            Link = address;
        }
